...
<html>
	...
	<title><?=$title?></title>
	<link href="<?php echo base_url('public/css/ingresos.css')?>" rel="stylesheet">
...
<body>
	...
	<div class="container">
		<h1 style="font-size:20pt">Listado de Ingresos</h1>
		<button class="btn btn-success" onclick="add_ingreso()"><i class="glyphicon glyphicon-plus"></i> Agregar Ingreso</button>
